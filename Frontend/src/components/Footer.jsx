            ...
            <div className = {` ${location.pathname == homePage ? "w-[50%] h-[320px]" : "w-[75%] h-[300px]" } " textGreen backgroundGolden z-10 rounded-3xl border-none ml-[7%] -mt-[18%] boxShadowright " `} >
                <div className="h-[90%] flex flex-row justify-evenly">
                    <div className="w-[45%] h-[100%] flex flex-col justify-evenly">
                        ...
                        <h1 className="text-[22px] ml-6 hover:text-2xl hover:underline pl-[20%]"><a href="mailto:aloghor@gmail.com"><img src={EmailIcon} alt="Email Icon" className="w-[7%] inline mr-2" /> aloghor@gmail.com</a></h1>
                        <h1 className="text-[22px] ml-6 pl-[20%]"><img src={PhoneIcon} alt="Phone Icon" className="w-[7%] inline mr-2" /> ০১XXXXXXXXX</h1>
                        <h1 className="text-[22px] ml-6 pl-[20%]"><img src={LocationIcon} alt="Location Icon" className="w-[7%] inline mr-2" /> ঢাকা, বাংলাদেশ</h1>
                    </div>

                    <div className="w-[45%] h-[100%] flex flex-col justify-evenly">
                        <h1 className="text-4xl pl-[23%] underline">অনুসরন করুন</h1>
                        <h1 className="text-[22px] ml-10 hover:text-2xl hover:underline pl-[20%]"><a href="https://www.facebook.com/profile.php?id=100078409717405" target="blank"><img src={FacebookIcon} alt="Facebook Icon" className="w-[7%] inline mr-2" /> আলোঘর </a></h1>
                        <h1 className="text-[22px] ml-10 hover:text-2xl hover:underline pl-[20%]"><a href="https://x.com/LabibT" target="blank"><img src={XIcon} alt="Twitter Icon" className="w-[7%] inline mr-2" /> @Aloghor</a></h1>
                        <h1 className="text-[22px] ml-10 hover:text-2xl hover:underline pl-[20%]"><a href="https://www.reddit.com/user/LTNEW52/" target="blank"><img src={RedditIcon} alt="Reddit Icon" className="w-[7%] inline mr-2" /> u/Aloghor</a></h1>
                    </div>
                </div>
