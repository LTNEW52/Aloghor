...
const DiscussionOverview = () => {
    ...
    const discussionPreviews = {
        0:{
            ...
            snippet: "গত এক দশকে বাংলা সায়েন্স ফিকশন ধারায় কিছু উল্লেখযোগ্য পরিবর্তন দেখা গেছে। পাঠকেরা এই বিষয়ে নিজেদের মতামত দিচ্ছেন…",
            author: "সৈকত দে",
            comments: 12,
            date: "১ দিন আগে",
        ...
        1:{
            ...
            snippet: "আধুনিক বাংলা সাহিত্যে নারীর ভূমিকায় কী ধরনের পরিবর্তন এসেছে? এই আলোচনায় পাঠকেরা জানাচ্ছেন তাদের নিজস্ব বিশ্লেষণ…",
        ...
        2:{
            ...
            snippet: "কিছু পাঠকের মতে হুমায়ূন আহমেদের চরিত্রগুলোর গভীরতা কমে গেছে তার শেষদিকের লেখাগুলোতে। অন্যদিকে অনেকেই তা মানতে নারাজ…",
            author: "রাফিদ হাসান",
            comments: 15,
            date: "আজ",
    ...
    return (
        <div className="w-[60%] h-[430px] ml-auto mr-10 my-10">
            <h1 className="textGolden text-5xl font-bold italic underline mt-5 text-center animate-bounce textShadow">এই মুহূর্তের আলোচনায়</h1>
            <div className={`my-10 w-[100%] h-[82%] flex ${animate ? "flipUp" : ""} boxShadowleft backgroundGreen p-6 rounded-xl boxShadowleft`} >
                <div className="w-[100%] h-full textGolden p-8 textShadow">
                    ...
                    <h1 className="text-[23px] text-left ml-[5%]">লিখেছেন {discussionPreviews[cardsNum].author} . {discussionPreviews[cardsNum].comments} মন্তব্য . {discussionPreviews[cardsNum].date}</h1>
