            ...
            <div>
                <div className="h-[80%]">
                    ...
                    <div className="p-10 h-fit flex flex-col items-center relative text-golden">
                        <label htmlFor="text" className="absolute top-[4%] left-35 text-[1.3rem] font-medium px-2 mixedColor bg-white">নাম</label>
                        <img src={NameIcon} alt="Email Icon" className="absolute w-[3%] top-[8%] left-44" />
                        <input type="text" placeholder="এখানে আপনার নাম লিখুন" className=" w-[70%] h-[50px] mb-12 bg-white border-1 hover:border-3 focus:border-3 rounded-lg text-[1.3rem] pl-23"/>
                        <label htmlFor="text" className="absolute top-[19.8%] left-35 text-[1.3rem] font-medium px-2 mixedColor bg-white">ইউজারনেম</label>
                        <img src={UsernameIcon} alt="Email Icon" className="absolute w-[3%] top-[24.5%] left-44" />
                        <input type="text" placeholder="এখানে আপনার ইউজারনেম দিন" className=" w-[70%] h-[50px] bg-white mb-12 border-1 hover:border-3 focus:border-3 rounded-lg text-[1.3rem] pl-23"/>
