...
const LiteratureNews = () => {
  const newsStore = {
    0: {
      ...
      summary:
        "বিংশ শতাব্দীর বাংলা সাহিত্যের অন্যতম শ্রেষ্ঠ কথাসাহিত্যিক মানিক বন্দ্যোপাধ্যায়ের জন্মদিন আজ। ১৯০৮ সালের ১৯ মে (আজকের দিনে) ভারতের বিহারের সাঁওতাল পরগনা, বর্তমান ঝাড়খণ্ড রাজ্যের দুমকা শহরে প্রখ্যাত এ লেখকের জন্ম।",
      image:
        "https://asset.kalerkantho.com/public/news_images/2025/05/19/1747632090-c272ffa290a15f4ca1949bea975b1157.jpg",
    ...
    1: {
      ...
      summary:
        "বিশ্ব বই দিবস আজ বুধবার (২৩ এপ্রিল)। জাতিসংঘের শিক্ষা, বৈজ্ঞানিক ও সাংস্কৃতিক সংগঠন ইউনেসকো ১৯৯৫ সালের ২৩ এপ্রিলকে প্রথমবারের মতো বিশ্ব বই দিবস হিসেবে উপযাপন করে। এ উপলক্ষ্যে দেখে নেওয়া যাক বিশ্বের কোন দেশের মানুষ বেশি বা কম বই পড়েন।",
      image:
        "https://cdn.ittefaqbd.com/contents/cache/images/1100x618x1/uploads/media/2025/04/23/cfcbf3793d505d04def5660bbd6c5557-6808d4d370b8a.jpg?jadewits_media_id=222057",
    ...
    2: {
      ...
      summary:
        "আগেই জানানো হয়েছিল পুরস্কার প্রাপকদের নাম, সেই তালিকা নিয়ে ওঠে বিতর্কও। পুরস্কার ঘোষণা, স্থগিতের পর নতুন তালিকা প্রকাশ আলোচনার জন্ম দিয়েছিল। আলেচিত সেই ‘বাংলা একাডেমি সাহিত্য পুরস্কার ২০২৪’ নিলেন সাত লেখক।",
      image:
        "https://cdn.ittefaqbd.com/contents/cache/images/1100x618x1/uploads/media/2025/02/01/77d4972593fa2b305b81d53dc814236e-679e0c36321ea.jpg?jadewits_media_id=208936",
    ...
    3: {
      ...
      summary:
        "স্যার আর্থার কোনান ডয়েল জগৎ বিখ্যাত কিশোর উপন্যাস ‘পিটার প্যান’ স্রষ্টা জেমস ব্যারির সাথে ক্রিকেট খেলছেন, ‘প্রিজনার অফ জেন্ডা’র লেখক অ্যান্থনি হোপ তার সহ-খেলোয়াড় অথবা ‘দ্যা জঙ্গল বুক’ লেখক রুডিয়ার্ড কিপলিং এবং তিনি ভারমন্টের মাঠে গলফ খেলছেন ...",
      image:
        "https://media.prothomalo.com/prothomalo-bangla%2F2025-05-21%2Fhzsru4h3%2FOnnoalo-.jpg?rect=0%2C0%2C1400%2C933&w=622&auto=format%2Ccompress&fmt=avif",
      src: "https://www.prothomalo.com/onnoalo/treatise/g1ce4rzbaw",
    },
    4: {
      title: "বাংলাদেশের সমকালীন সাহিত্য নিয়ে আগ্রহ আছে",
      summary:
        "চীনা ভাষায় রবীন্দ্র–রচনাবলীর অনুবাদক দং ইউ ছেন। বেইজিং ফরেন ইউনির্ভাসিটির সেন্টার ফর সাউথ এশিয়া স্টাডিজের সাবেক অধ্যাপক তিনি। এখন কাজ করছেন বিদ্রোহী কবি কাজী নজরুল ইসলামের জীবনী নিয়ে। সাক্ষাৎকার নিয়েছেন সাদিয়া মাহ্জাবীন ইমাম।",
      image:
        "https://media.prothomalo.com/prothomalo-bangla%2F2025-03-14%2F34pctssz%2FDong-u.JPG?rect=0%2C0%2C5028%2C3352&w=300&auto=format%2Ccompress&fmt=avif",
      src: "https://www.kalerkantho.com/online/sahitya/2025/05/19/1519588",
    },
    5: {
      title: "বাংলাদেশে ব্যক্তিতান্ত্রিক স্বৈরতন্ত্রের লক্ষণসমূহ",
      summary:
        "ব্যক্তিতান্ত্রিক স্বৈরতান্ত্রিক শাসনের যেসব বৈশিষ্ট্য বিশ্বের অন্যত্র সহজেই দেখা যায়, বাংলাদেশে ২০১১ সাল থেকেই তার কিছু লক্ষণ শেখ হাসিনার বক্তব্য এবং আচরণের মধ্যে দৃশ্যমান হয়ে উঠতে থাকে। ২০১৪ সাল নাগাদ এগুলো কার্যত রাখঢাক ছাড়াই স্পষ্ট হয়ে ওঠে।",
      image:
        "https://media.prothomalo.com/prothomalo-bangla%2F2025-01-31%2Fznnrpw5z%2FAmi-Rastro3-archive-copy.jpg?rect=0%2C0%2C2990%2C1993&w=622&auto=format%2Ccompress&fmt=avif",
  ...
  return (
    <div className="w-[65%] h-[580px] ml-10 mb-25">
      ...
      <div
        className={`my-10 w-[100%] h-[82%] flex ${animate ? "flipSide" : ""} boxShadowright backgroundGolden p-6 rounded-xl`}
      >
        <div className="w-[40%] h-inherit">
          <img
            src={newsStore[cardsNum].image}
            alt={newsStore[cardsNum].title}
        ...
        <div className="w-[60%] h-full textGreen ml-auto p-8">
          ...
          <a href={newsStore[cardsNum].src} target="blank">
            <p className="text-[23px] text-right hover:underline hover:text-[30px]">
              &#8594; বিস্তারিত দেখুন
            </p>
          </a>
        </div>
