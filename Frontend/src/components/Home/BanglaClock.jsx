...
const BanglaClock = () => {
    ...
    const BanglaNum = {"0":"০" , "1":"১" , "2":"২" , "3":"৩" , "4":"৪" , "5":"৫" , "6":"৬" , "7":"৭" , "8":"৮" , "9":"৯"}
    ...
    let banglaYear = (currentDate >= 14 && currentMonth >= 3 ? currentYear - 593 : currentYear - 594).toString()
    banglaYear = BanglaNum[banglaYear[0]]+BanglaNum[banglaYear[1]]+BanglaNum[banglaYear[2]]+BanglaNum[banglaYear[3]]
    ...
    let banglaDate = null
        ...
        for (let i = 0 ; i < banglaMonths.length ; i++) {
            if (banglaMonth == banglaMonths[i].name) {
                    if (currentMonth == banglaMonths[i].start[0]) {
                        ...
                        banglaDate = ((new Date(currentYear , currentMonth , 0).getDate() - banglaMonths[i].start[1] + 1) + currentDate)
                }
            }
        }
        ...
        return [timeofDay , hour , minute , second , dayName , banglaDate , banglaMonth , banglaYear , banglaGreetings[timeofDay].greeting , banglaGreetings[timeofDay].message]
    }

    function getDayName(date) {
        let dayName = null
        switch(date.getDay()) {
                case 1 : dayName = "সোমবার";
                break;
                case 2 : dayName = "মঙ্গলবার";
                break;
                case 3 : dayName = "বুধবার";
                break;
                case 4 : dayName = "বৃহস্পতিবার";
                break;
                case 5 : dayName = "শুক্রবার";
                break;
                case 6 : dayName = "শনিবার";
                break;
                case 0 : dayName = "রবিবার";
                break;
            }
        return dayName;
    }
    ...
    function getBanglaMonth (currentDate , currentMonth) {
        ...
        if ((currentDate >= 14 && currentMonth == 3) || (currentDate < 15 && currentMonth == 4)) {
            banglaMonth = "বৈশাখ";
        }else if ((currentDate >= 15 && currentMonth == 4) || (currentDate < 15 && currentMonth == 5)) {
            banglaMonth = "জ্যৈষ্ঠ";
        }else if ((currentDate >= 15 && currentMonth == 5) || (currentDate < 16 && currentMonth == 6)) {
            banglaMonth = "আষাঢ়";
        }else if ((currentDate >= 16 && currentMonth == 6) || (currentDate < 17 && currentMonth == 7)) {
            banglaMonth = "শ্রাবন";
        }else if ((currentDate >= 17 && currentMonth == 7) || (currentDate < 17 && currentMonth == 8)) {
            banglaMonth = "ভাদ্র";
        }else if ((currentDate >= 17 && currentMonth == 8) || (currentDate < 18 && currentMonth == 9)) {
            banglaMonth = "আশ্বিন";
        }else if ((currentDate >= 18 && currentMonth == 9) || (currentDate < 17 && currentMonth == 10)) {
            banglaMonth = "কার্তিক";
        }else if ((currentDate >= 17 && currentMonth == 10) || (currentDate < 16 && currentMonth == 11)) {
            banglaMonth = "অগ্রহায়ণ";
        }else if ((currentDate >= 16 && currentMonth == 11) || (currentDate < 15 && currentMonth == 0)) {
            banglaMonth = "পৌষ";
        }else if ((currentDate >= 15 && currentMonth == 0) || (currentDate < 13 && currentMonth == 1)) {
            banglaMonth = "মাঘ";
        }else if ((currentDate >= 13 && currentMonth == 1) || (currentDate < 15 && currentMonth == 2)) {
            banglaMonth = "ফাল্গুন";
        }else if((currentDate >= 15 && currentMonth == 2) || (currentDate < 14 && currentMonth == 3)) {
            banglaMonth = "চৈত্র";
        }
        return banglaMonth
    }
    ...
    return (
        <>
            <div className="border-none rounded-full text-3xl backgroundGreen w-fit m-auto py-5 px-10 textShadow boxShadowright text-center">
                ...
                <h1 className="mb-2">এখন {banglaClockState[0]} {banglaClockState[1]}টা বেজে {banglaClockState[2]} মিনিট {banglaClockState[3]} সেকেন্ড</h1>
                <h1>আজ {banglaClockState[5]} {banglaClockState[6]} {banglaClockState[7]} বঙ্গাব্দ, রোজ {banglaClockState[4]}</h1>
            </div>
        </>
    )
}
