...
const Book = () => {
    ...
    const bookImage = {
        ...
        "The Six Sacred Stone": "https://upload.wikimedia.org/wikipedia/en/f/ff/The_Six_Sacred_Stones_cover.jpg",
        ...
        "শার্লক হোমস সমগ্র": "https://blogger.googleusercontent.com/img/b/R29vZ2xl/AVvXsEjiyKd0DzQtUkIypxcDmGqcJ_ksdUOz9P7UiEiJKAakrK_J4T3SI3EYtm2E0HMBtcWtmWeBGYoau9Q8Ev1W5ion0VcpWr8e2WKQgMNp1Z48_01rA36eLl8IkpwRCu24k4IHTJ5Az_5mNcVv/s1600/SherlockHolmesSamagra1AdrishBardhantranslated-cover_zps8465c1e5.jpg",
        "হিমু সমগ্র": "https://allbanglaboi.com/wp-content/uploads/2016/09/Himu-Somogro-PDF-01-201x300.jpg",
        "Digital Fortress": "https://upload.wikimedia.org/wikipedia/en/c/c9/DigitalFortress.jpg",
        "Queen Sheba's Ring": "https://upload.wikimedia.org/wikipedia/en/thumb/6/64/Queen_Sheba%27s_Ring.jpg/250px-Queen_Sheba%27s_Ring.jpg",
        "ভৌতিক গল্পসমগ্র - শীর্ষেন্দু মুখোপাধ্যায়": "https://cdn.ebanglalibrary.com/wp-content/uploads/2024/08/Bhoutik-Galpasamagra-Shirshendu-Mukhopadhyay.jpg.webp",
        "সেরা ভূতের গল্প - ব্রাম স্টোকার": "https://cdn.ebanglalibrary.com/wp-content/uploads/2023/05/Anish-Sera-Burter-Galpa.jpg.webp"
    };
        ...
        <div className="w-[100%] h-[1400px] my-10 flex flex-row">
            <div className="w-[20%] h-[100%] textGreen flex flex-col justify-evenly items-center">
                ...
                <div className="w-[95%] h-fit backgroundGolden rounded-2xl">
                    ...
                    <div className="w-[100%] h-[180px] text-2xl textGreen font-medium flex flex-col justify-evenly m-auto">
                        <Slider range min={minValue} max={maxValue} step={100} value={[minRange , maxRange]} onChange={(e) => {setMinRange(e[0]) ; setMaxRange(e[1])}}/>
                        <div>
                            <label htmlFor="text" className="ml-2 mr-20">৳<input type="text" className="ml-2 w-[30%] border-2 bg-white text-center" value={minRange} onChange={(e) => {
                                if (e.target.value >= minValue && e.target.value <= maxValue) {
                                    setMinRange(Number(e.target.value));
                                }
                            }}/></label>
                            <label htmlFor="number">৳<input type="text" className="ml-2 w-[30%] border-2 bg-white text-center" value={maxRange} onChange={(e) => {
                                if (e.target.value >= minValue && e.target.value <= maxValue)
                ...
                <div className="w-[95%] h-fit backgroundGolden rounded-2xl">
                    ...
                    <hr className="border-[1.5px]"/>
                    <div className="w-[100%] h-[180px] text-2xl py-5 px-10 textGreen font-medium overflow-auto">
                        <input type="text" placeholder="লেখকের নাম লিখুন" className="w-[100%] my-2 bg-white pl-2 rounded-2xl" 
                        onChange={(e) => {
                            setMatchedAuthors(Object.keys(allAuthors).filter(authors => authors.includes(e.target.value.toLowerCase())).map(authors => allAuthors[authors]));
                        ...
                        <div className={`w-[100%] rounded-2xl py-3 font-semibold ${showAuthorDiv ? "" : "hidden"}`}>
            ...
            <div className="w-[80%] h-[100%]">
                <div className="w-[100%] h-[10%]  flex flex-row justify-evenly items-center text-3xl textGolden font-semibold">
                    <button className="w-fit h-fit p-5 backgroundGreen rounded-full cursor-pointer hover:bg-[hsl(92,30%,27%)]">উপন্যাস</button>
                    <button className="w-fit h-fit p-5 backgroundGreen rounded-full cursor-pointer hover:bg-[hsl(92,30%,27%)]">ভৌতিক</button>
                    <button className="w-fit h-fit p-5 backgroundGreen rounded-full cursor-pointer hover:bg-[hsl(92,30%,27%)]">গোয়েন্দা</button>
                    <button className="w-fit h-fit p-5 backgroundGreen rounded-full cursor-pointer hover:bg-[hsl(92,30%,27%)]">নতুন প্রকাশ</button>
                    <button className="w-fit h-fit p-5 backgroundGreen rounded-full cursor-pointer hover:bg-[hsl(92,30%,27%)]">আলোঘরে সদ্য যুক্ত</button>
                    <button className="w-fit h-fit p-5 backgroundGreen rounded-full cursor-pointer hover:bg-[hsl(92,30%,27%)]">বেস্টসেলার</button>
                    <button className="w-fit h-fit p-5 backgroundGreen rounded-full cursor-pointer hover:bg-[hsl(92,30%,27%)]">আলোঘর বেস্টসেলার</button>
                </div>

                <div className="w-[100%] h-[90%] overflow-auto">
                    {
                        Object.keys(bookImage).map((bookIndex) => (
                            <BookCard imgSrc={bookImage[bookIndex]} tailCss = "w-[15%] h-[30%] hover:border-5 text-red-500 my-15 mx-18 inline-block"></BookCard>
                        ))
                    }
                </div>
            </div>
