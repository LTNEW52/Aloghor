...
const Home = () => {
    ...
    return (
        <>
            <div className="textGolden w-1/2 px-8 ml-10 2xl:mt-10 2xl:mb-15 xl:my-7 userSelectNone">
            ...
            <div className="border textGolden w-[60%] ml-auto mr-10 backgroundGolden p-5 h-[550px] boxShadowleft">
