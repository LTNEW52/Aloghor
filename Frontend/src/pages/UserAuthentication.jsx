...
const UserAuth = () => {
  ...
  return (
    <div className="min-h-screen backdrop-blur-xs flex flex-col justify-center items-center">
      <div
        className={`w-[90%] h-[900px] border-none backgroundGolden boxShadowleft rounded-xl ${hasFliped ? (isSignUp ? "flipSide" : "flipSideReverse") : ""} `}
      >
        <div className="w-[100%] h-[100%] flex flex-row">
          <img
            src="../public/Image/homePeopleReading.jpg"
            alt="Login Page Picture"
            className={`w-[60%] h-[100%] object-cover rounded-t-xl rounded-b-xl ${isSignUp ? "order-1" : "order-0"}`}
          />
          {isSignUp ? (
